...
```SQL
SELECT COUNT(o.customer_id) as ordercount, o.customer_id as idfromorder, c.customer_id as idfromcustomer
FROM orders o JOIN customers c
ON o.customer_id = c.customer_id
GROUP BY idfromorder, idfromcustomer
...
```SQL
SELECT COUNT(o.customer_id) as ordercount, c.contact_name as customername
FROM orders o JOIN customers c
ON o.customer_id = c.customer_id
...
```SQL
SELECT COUNT(o.customer_id) as ordercount, c.city as customercity
FROM orders o JOIN customers c
ON o.customer_id = c.customer_id
...
| Location Id | Person Id |   Location   |
|-------------|-----------|--------------|
| 1           | 1         | Fenced Yard  |
| 2           | 3         | City Dweller |
|             |           |              |
